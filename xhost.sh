...
#
# Install: cd /usr/local/bin && wget -O xhost https://raw.githubusercontent.com/debihard/dbcreator/master/xhost.sh && chmod +x xhost
#
# Usage: xhost
#
...
if grep -xq "  GeoIPEnable On" /etc/apache2/mods-available/geoip.conf ; then
